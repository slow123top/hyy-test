...
!function (t, e) {
    ...
    return function (t) {
        ...
        var o = n.AMUI || {}, s = n(window), a = window.document, r = n("html");
        o.VERSION = "2.6.2", o.support = {}, o.support.transition = function () {
            var t = function () {
            ...
            if (!o)return !1;
            var a = s.scrollLeft(), r = s.scrollTop(), l = i.offset(), c = l.left, h = l.top;
            return e = n.extend({
                topOffset: 0,
                leftOffset: 0
            ...
            i = i || {}, n.fn[t] = function (s) {
                var a, r = Array.prototype.slice.call(arguments, 0), l = r.slice(1), c = this.each(function () {
                    var c = n(this), h = "amui." + t, u = i.dataOptions || "data-am-" + t, d = c.data(h), p = n.extend({}, o.utils.parseOptions(c.attr(u)), "object" == typeof s && s);
        ...
        function E(t, e, i) {
            var n = i.pointers.length, o = i.changedPointers.length, s = e & Dt && n - o === 0, a = e & (At | $t) && n - o === 0;
        ...
        function S(t, e) {
            ...
            var s = i.firstInput, a = i.firstMultiple, r = a ? a.center : s.center, l = e.center = A(n);
        ...
        function F(t) {
            ...
            return {timeStamp: mt(), pointers: e, center: A(e), deltaX: t.deltaX, deltaY: t.deltaY}
        }
        ...
        function W(t, e) {
            ...
            var o, s, a = g(t.changedTouches), r = [], l = this.target;
            if (s = i.filter(function (t) {
                    return p(t.target, l)
                }), e === Dt)for (o = 0; o < s.length;)n[s[o].identifier] = !0, o++;
        ...
        var at, rt = i(1), lt = i(2), ct = ["", "webkit", "Moz", "MS", "ms", "o"], ht = document.createElement("div"), ut = "function", dt = Math.round, pt = Math.abs, mt = Date.now;
        ...
        var ft = a(function (t, e, i) {
            ...
            return t
        }, "extend", "Use `assign`."), vt = a(function (t, e) {
            return ft(t, e, !0)
        }, "merge", "Use `assign`."), gt = 1, wt = /mobile|tablet|ip(ad|hone|od)|android/i, yt = "ontouchstart" in window, bt = void 0 !== y(window, "PointerEvent"), Tt = yt && wt.test(navigator.userAgent), xt = "touch", Ct = "pen", Et = "mouse", St = "kinect", kt = 25, Dt = 1, Ft = 2, At = 4, $t = 8, Mt = 1, Pt = 2, Nt = 4, It = 8, Ot = 16, Lt = Pt | Nt, _t = It | Ot, zt = Lt | _t, Rt = ["x", "y"], qt = ["clientX", "clientY"];
        x.prototype = {
            handler: function () {
            }, init: function () {
        ...
        var Wt = {mousedown: Dt, mousemove: Ft, mouseup: At}, Ht = "mousedown", Vt = "mousemove mouseup";
        r(L, x, {
            handler: function (t) {
                var e = Wt[t.type];
        ...
        var Bt = {pointerdown: Dt, pointermove: Ft, pointerup: At, pointercancel: $t, pointerout: $t}, Ut = {
            2: xt,
            3: Ct,
            4: Et,
            5: St
        }, Xt = "pointerdown", Yt = "pointermove pointerup pointercancel";
        window.MSPointerEvent && !window.PointerEvent && (Xt = "MSPointerDown", Yt = "MSPointerMove MSPointerUp MSPointerCancel"), r(_, x, {
            handler: function (t) {
                var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Bt[n], s = Ut[t.pointerType] || t.pointerType, a = s == xt, r = v(e, t.pointerId, "pointerId");
        ...
        var jt = {
            ...
            touchend: At,
            touchcancel: $t
        }, Zt = "touchstart", Gt = "touchstart touchmove touchend touchcancel";
        r(z, x, {
            handler: function (t) {
                var e = jt[t.type];
        ...
        r(q, x, {
            handler: function (t) {
                var e = Jt[t.type], i = W.call(this, t, e);
            ...
            handler: function (t, e, i) {
                var n = i.pointerType == xt, o = i.pointerType == Et;
        ...
        var Qt = y(ht.style, "touchAction"), te = void 0 !== Qt, ee = "compute", ie = "auto", ne = "manipulation", oe = "none", se = "pan-x", ae = "pan-y";
        V.prototype = {
            set: function (t) {
                ...
                if (!te) {
                    ...
                    var n = this.actions, o = m(n, oe), s = m(n, ae), a = m(n, se);
                    if (o) {
        ...
        var re = 1, le = 2, ce = 4, he = 8, ue = he, de = 16, pe = 32;
        U.prototype = {
            ...
            defaults: {pointers: 1}, attrTest: function (t) {
                ...
                var e = this.state, i = t.eventType, n = e & (le | ce), o = this.attrTest(t);
            ...
            defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
                ...
                if (this._input = t, !o || !i || t.eventType & (At | $t) && !s)this.reset(); else if (t.eventType & Dt)this.reset(), this._timer = n(function () {
            ...
            defaults: {event: "swipe", threshold: 10, velocity: .3, direction: Lt | _t, pointers: 1},
            getTouchAction: function () {
            ...
            inputTarget: null,
            inputClass: null,
            preset: [[Q, {enable: !1}], [J, {enable: !1}, ["rotate"]], [tt, {direction: Lt}], [G, {direction: Lt}, ["swipe"]], [et], [et, {
                event: "doubletap",
                taps: 2
            }, ["tap"]], [K]],
            cssProps: {
        ...
        "use strict";
        var n = i(1), o = i(2), s = function (t, e) {
            var i = this;
        ...
        s.DEFAULTS = {
            ...
            var i = this.$element, s = "disabled", a = i.data(), r = this.options, l = i.is("input") ? "val" : "html", c = "am-btn-" + t + " " + r.disabledClassName;
        ...
        var o = i(1), s = i(2), a = function (t, e) {
        ...
        a.DEFAULTS = {toggle: !0}, a.prototype.open = function () {
            ...
            var e, i = o(this), a = s.utils.options(i.attr("data-am-collapse")), r = a.target || t.preventDefault() || (e = i.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""), l = o(r), c = l.data("amui.collapse"), h = c ? "toggle" : a, u = a.parent, d = u && o(u);
        ...
        "use strict";
        var n = i(1), o = i(2), s = n(document), a = function (t, e) {
        ...
        "use strict";
        var n = i(1), o = i(2), s = n(document), a = o.support.transition, r = function () {
        ...
        "use strict";
        var n = i(1), o = i(2), s = o.support.animation, a = function (t, e) {
        ...
        a.DEFAULTS = {
            ...
            var e = this.$toggle, i = this.$element, o = this.$dropdown;
            ...
            if (this.$dropdown.length) {
                ...
                this.$justify && t.css({"min-width": this.$justify.css("width")}), i + (e.left - s) > o && this.$element.addClass("am-dropdown-flip")
            }
        ...
        (function (e) {
            ...
            n.flexslider = function (t, i) {
                ...
                var a, r = o.vars.namespace, l = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, c = ("ontouchstart" in window || l || window.DocumentTouch && document instanceof DocumentTouch) && o.vars.touch, h = "click touchend MSPointerUp keyup", u = "", d = "vertical" === o.vars.direction, p = o.vars.reverse, m = o.vars.itemWidth > 0, f = "fade" === o.vars.animation, v = "" !== o.vars.asNavFor, g = {};
                n.data(t, "flexslider", o), g = {
                    init: function () {
                        ...
                        setup: function () {
                            o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(r + "active-slide").eq(o.currentItem).addClass(r + "active-slide"), l ? (t._slider = o, o.slides.each(function () {
                                ...
                                t.preventDefault();
                                var e = n(this), i = e.index(), s = e.offset().left - n(o).scrollLeft();
                        ...
                        setup: function () {
                            ...
                            var t, e, i = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging", s = 1;
                            ...
                            o.controlsContainer ? n(o.controlsContainer).append(o.controlNavScaffold) : o.append(o.controlNavScaffold), g.controlNav.set(), g.controlNav.active(), o.controlNavScaffold.delegate("a, img", h, function (t) {
                                if (t.preventDefault(), "" === u || u === t.type) {
                                    var e = n(this), i = o.controlNav.index(e);
                        ...
                        function n(i) {
                            ...
                            if (n) {
                                var o = -i.translationX, s = -i.translationY;
                        ...
                        var a, r, c, h, u, v, g, w, y, b = !1, T = 0, x = 0, C = 0;
                        l ? (t.style.msTouchAction = "none", t._gesture = new MSGesture, t._gesture.target = t, t.addEventListener("MSPointerDown", i, !1), t._slider = o, t.addEventListener("MSGestureChange", n, !1), t.addEventListener("MSGestureEnd", s, !1)) : (g = function (e) {
                            ...
                            if (t.removeEventListener("touchmove", w, !1), o.animatingTo === o.currentSlide && !b && null !== u) {
                                var i = p ? -u : u, n = i > 0 ? o.getTarget("next") : o.getTarget("prev");
                        ...
                        var e = n(o.vars.sync).data("flexslider"), i = o.animatingTo;
                        switch (t) {
                            case"animate":
                    ...
                    if (o.vars.animationLoop || t === o.currentSlide || (o.direction = t > o.currentSlide ? "next" : "prev"), v && 1 === o.pagingCount && (o.direction = o.currentItem < t ? "next" : "prev"), !o.animating && (o.canAdvance(t, a) || i) && o.is(":visible")) {
                        ...
                        if (o.animating = !0, o.animatingTo = t, e && o.pause(), o.vars.before(o), o.syncExists && !a && g.sync("animate"), o.vars.controlNav && g.controlNav.active(), m || o.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), o.atEnd = 0 === t || t === o.last, o.vars.directionNav && g.directionNav.update(), t === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), f)c ? (o.slides.eq(o.currentSlide).css({
                            ...
                            opacity: 1,
                            zIndex: 2
                        }), o.wrapup(y)) : (o.slides.eq(o.currentSlide).css({zIndex: 1}).animate({opacity: 0}, o.vars.animationSpeed, o.vars.easing), o.slides.eq(t).css({zIndex: 2}).animate({opacity: 1}, o.vars.animationSpeed, o.vars.easing, o.wrapup)); else {
                    ...
                    var n = function () {
                        var i = t ? t : (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo, n = function () {
        ...
        (function (t, n) {
            ...
            var s = i(13).nextTick, a = Function.prototype.apply, r = Array.prototype.slice, l = {}, c = 0;
        ...
        var o = i(2), s = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
        ...
        n.prototype = {
            version: "5.1.3", _init: function () {
                ...
                if (this.enabled && a.eventType[t.type] === this.initiated) {
                    ...
                    var e, i, n = (t.changedTouches ? t.changedTouches[0] : t, a.getTime() - this.startTime), o = Math.round(this.x), s = Math.round(this.y), r = Math.abs(o - this.startX), l = Math.abs(s - this.startY), c = 0, h = "";
                    if (this.isInTransition = 0, this.initiated = 0, this.endTime = a.getTime(),
        ...
        function n(t, e) {
            return this.each(function () {
                var i = o(this), n = i.data("amui.modal"), s = "object" == typeof t && t;
                n || i.data("amui.modal", n = new c(this, s)), "string" == typeof t ? n[t] && n[t](e) : n.toggle(t && t.relatedTarget || void 0)
            })
        }

        var o = i(1), s = i(2), a = i(9), r = o(document), l = s.support.transition, c = function (t, e) {
        ...
        c.DEFAULTS = {
            ...
            var e = this.$element, i = this.options, n = this.isPopup, s = i.width, a = i.height, r = {};
            ...
            if (this.active) {
                ...
                this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd), this.dimmer.close(e, !0)), this.$element.trigger(o.Event("close.modal.amui", {relatedTarget: t})), this.transitioning = 1;
                var s = function () {
            ...
            var t = this.options, e = this, i = this.$element, n = i.find(".am-modal-prompt-input"), s = i.find("[data-am-modal-confirm]"), a = i.find("[data-am-modal-cancel]"), r = function () {
                var t = [];
            ...
            this.options.cancelable && i.on("keyup.modal.amui", function (t) {
                ...
                i.trigger(o.Event("confirm.modal.amui", {trigger: this}))
            }), a.on("click.cancel.modal.amui", function () {
                i.trigger(o.Event("cancel.modal.amui", {trigger: this}))
        ...
        function n(t, e) {
            ...
            return this.each(function () {
                var n = o(this), s = n.data("amui.offcanvas"), a = o.extend({}, "object" == typeof t && t);
        ...
        var o = i(1), s = i(2);
        i(3);
        var a, r = o(window), l = o(document), c = function (t, e) {
        ...
        c.DEFAULTS = {duration: 300, effect: "overlay"}, c.prototype.open = function (t) {
            ...
            if (i.length && !i.hasClass("am-active")) {
                var n = this.options.effect, s = o("html"), l = o("body"), c = i.find(".am-offcanvas-bar").first(), h = c.hasClass("am-offcanvas-bar-flip") ? -1 : 1;
                c.addClass("am-offcanvas-bar-" + n), a = {
                    ...
                    height: r.height()
                }).addClass("am-offcanvas-page"), "overlay" !== n && l.css({"margin-left": c.outerWidth() * h}).width(), s.css("margin-top", -1 * a.y), setTimeout(function () {
            ...
            var i = this, n = o("html"), r = o("body"), l = this.$element, c = l.find(".am-offcanvas-bar").first();
            ...
            t.preventDefault();
            var e = o(this), i = s.utils.parseOptions(e.data("amOffcanvas")), a = o(i.target || this.href && this.href.replace(/.*(?=#[^\s]+$)/, "")), r = a.data("amui.offcanvas") ? "open" : i;
            n.call(a, r, this)
        }), t.exports = s.offcanvas = c
    }, function (t, e, i) {
        "use strict";
        var n = i(1), o = i(2), s = function (t) {
            var e = function (e, i) {
            ...
            var o = function (t, e) {
                ...
                t.addEventListener("touchstart", function (t) {
                    ...
                    if (e.enabled) {
                        if (p)r(t), i && u(t), s = l(t.touches); else {
                            switch (i) {
                                case"zoom":
        ...
        "use strict";
        var n = i(1), o = i(2), s = n(window), a = function (t, e) {
        ...
        a.DEFAULTS = {
            ...
            if (e && e.length) {
                var i = e.outerWidth(), n = e.outerHeight(), o = e.find(".am-popover-caret"), a = o.outerWidth() / 2 || 8, r = n + 8, l = t.outerWidth(), c = t.outerHeight(), h = t.offset(), u = t[0].getBoundingClientRect(), d = s.height(), p = s.width(), m = 0, f = 0, v = 0, g = 2, w = "top";
                e.css({
                    left: "",
                    top: ""
            ...
            var t = o.utils.generateGUID("am-popover"), e = [];
        ...
        var n = i(2), o = function () {
            ...
            function i(t, i, n) {
                var o;
                return o = "translate3d" === c.positionUsing ? {transform: "translate3d(" + e(t) + "%,0,0)"} : "translate" === c.positionUsing ? {transform: "translate(" + e(t) + "%,0)"} : {"margin-left": e(t) + "%"}, o.transition = "all " + i + "ms " + n, o
            }
            ...
            l.configure = function (t) {
                ...
                var o = l.render(!n), s = o.querySelector(c.barSelector), a = c.speed, r = c.easing;
                return o.offsetWidth, h(function (t) {
                    "" === c.positionUsing && (c.positionUsing = l.getPositioningCSS()), u(s, i(e, a, r)), 1 === e ? (u(o, {
                        ...
                        u(o, {transition: "all " + a + "ms linear", opacity: 0}), setTimeout(function () {
                            l.remove(), t()
                        }, a)
                    }, a)) : setTimeout(t, a)
                }), this
                ...
                var n, s = i.querySelector(c.barSelector), a = t ? "-100" : e(l.status || 0), h = document.querySelector(c.parent);
                return u(s, {
        ...
        "use strict";
        var n = i(1), o = i(2), s = i(17), a = i(3), r = o.support.animation, l = o.support.transition, c = function (t, e) {
        ...
        c.DEFAULTS = {
            ...
            var t = this, e = this.options, i = this.$element, o = this.$pureview;
            ...
            var t = this, e = this.options, i = this.$pureview, s = n([]), a = n([]), r = this.$images, l = r.length;
            ...
            if (!t.data(i)) {
                var o = n("<img>", {src: t.data("src"), alt: t.data("title")});
            ...
            var e = this.options, i = this.$slides, s = i.index(t), a = t.data("title") || "", r = e.className.active;
        ...
        s.DEFAULTS = {
            ...
            e.smooth && n.fn.smoothScroll && t.on("click", function (t) {
                t.preventDefault();
                var i = n(this), o = n(i.attr("href"));
                if (o) {
                    var s = e.offsetTop && !isNaN(parseInt(e.offsetTop)) && parseInt(e.offsetTop) || 0;
                    n(window).smoothScroll({position: o.offset().top - s})
                }
            })
        ...
        "use strict";
        var n = i(1), o = i(2), s = o.utils.rAF, a = o.utils.cancelAF, r = !1, l = function (t, e) {
            function i(t) {
            ...
            e = e || {};
            var h, u, d, p = n(t), m = parseInt(e.position) || l.DEFAULTS.position, f = p.scrollTop(), v = f, g = m - f, w = e.speed || Math.min(750, Math.min(1500, Math.abs(f - m))), y = function () {
                o()
            };
            if (!r && 0 !== g) {
        ...
        var s = function (t, e) {
            this.$element = n(t), this.options = n.extend({}, s.DEFAULTS, {placeholder: t.getAttribute("placeholder") || s.DEFAULTS.placeholder}, e), this.$originalOptions = this.$element.find("option"), this.multiple = t.multiple, this.$selector = null, this.initialized = !1, this.init()
        };
        s.DEFAULTS = {
            btnWidth: null,
            btnSize: null,
            ...
            var e = this.$element, i = this.options, n = [], s = e.find("optgroup");
            this.$originalOptions = this.$element.find("option"), this.multiple || null !== e.val() || this.$originalOptions.length && (this.$originalOptions.get(0).selected = !0), s.length ? s.each(function (e) {
                n.push({header: !0, group: e + 1, text: this.label}), s.eq(e).find("option").each(function (i, n) {
                    t(i, n, e)
                })
            }) : this.$originalOptions.each(function (e, i) {
                t(e, i, null)
            }), this.$list.html(o.template(i.listTpl, {options: n})), this.$shadowOptions = this.$list.find("> li").not(".am-selected-list-header")
        }, s.prototype.setChecked = function (t) {
            var e = this.options, i = n(t), o = i.hasClass(e.selectedClass);
            if (this.multiple) {
                var s = this.$list.find("." + e.selectedClass).length;
                if (!o && this.maxChecked <= s)return this.$element.trigger("checkedOverflow.selected.amui", {selected: this}), !1
            } else {
            ...
            var e = this, i = this.options, o = [], s = n([]);
            ...
            var t = this, e = "am-selected-list-header", i = o.utils.debounce(function (i) {
        ...
        "use strict";
        i(15);
        var n = i(1), o = i(2), s = i(26), a = document, r = n(a), l = function (t) {
        ...
        d.prototype.createDefault = function (t) {
            ...
            constructor: s, getModuleCount: function () {
                ...
                for (var e = 0, i = 0, n = 0, o = this.rsBlock.length / 3, s = new Array, r = 0; o > r; r++)for (var l = this.rsBlock[3 * r + 0], c = this.rsBlock[3 * r + 1], h = this.rsBlock[3 * r + 2], u = 0; l > u; u++)s.push([h, c]);
        ...
        s.DEFAULTS = {
            ...
            !this.sticked && l ? s.addClass(r) : this.sticked && !l && this.reset(), this.$holder.css({height: s.is(":visible") && "absolute" !== s.css("position") ? s.outerHeight() : ""}), l && s.css({
                top: n,
        ...
        function n(t) {
            ...
            return this.each(function () {
                var n = o(this), a = n.is(".am-tabs") && n || n.closest(".am-tabs"), r = a.data("amui.tabs"), l = o.extend({}, s.utils.parseOptions(n.data("amTabs")), o.isPlainObject(t) && t);
        ...
        var o = i(1), s = i(2), a = i(3), r = s.support.transition, l = s.support.animation, c = function (t, e) {
        ...
        c.DEFAULTS = {
            ...
            var e = this.options.activeClass, i = "number" == typeof t ? t : this.$navs.index(o(t));
            if (t = "number" == typeof t ? this.$navs.eq(i) : o(t), t && t.length && !this.transitioning && !t.parent("li").hasClass(e)) {
                var n = this.$tabNav, s = t.attr("href"), a = /^#.+$/, r = a.test(s) && this.$content.find(s) || this.$tabPanels.eq(i), l = n.find("." + e + " a")[0], c = o.Event("open.tabs.amui", {relatedTarget: l});
            ...
            this.transitioning = !0;
            var n = this.options.activeClass, s = e.find("> ." + n), a = i && r && !!s.length;
        ...
        s.DEFAULTS = {
            ...
            markValid: function (t) {
                var e = this.options, i = n(t.field), o = i.closest(".am-form-group");
            ...
            var e = this, i = this.$element, o = this.options, s = n(t), a = s.data("equalTo");
            a && s.attr("pattern", "^" + i.find(a).val() + "$");
            var r = s.attr("pattern") || !1, l = new RegExp(r), c = null, h = null, u = s.is("[type=checkbox]") ? (h = i.find('input[name="' + t.name + '"]')).filter(":checked").length : s.is("[type=radio]") ? (c = this.$element.find('input[name="' + t.name + '"]')).filter(":checked").length > 0 : s.val();
            s = h && h.length ? h.first() : s;
            var d = void 0 !== s.attr("required") && "false" !== s.attr("required"), p = parseInt(s.attr("maxlength"), 10), m = parseInt(s.attr("minlength"), 10), f = Number(s.attr("min")), v = Number(s.attr("max")), g = this.createValidity({
                field: s[0],
                valid: !0
            });
            ...
            var t = this, e = this.$element, i = this.options, o = e.find(i.allFields).not(i.ignore), s = [], a = !0, r = [], l = n([]), c = [], h = !1;
            ...
            u.each(function () {
                var i = n(this), o = t.isValid(this), s = i.data("validity");
            ...
            var e, i, o = s.validationMessages[this.options.locales], a = "%s", r = n(t.field);
        ...
        (function (e) {
            ...
            var o, s = i(2), a = {}, r = "undefined" != typeof window ? window : e, l = "localStorage";
        ...
        var o = i(1), s = i(2);
        i(7), o(n), t.exports = s.accordion = {VERSION: "2.1.0", init: n}
    }, function (t, e) {
        "use strict";
        ...
        var o = i(1), s = i(2);
        o(window).on("load", n), t.exports = s.duoshuo = {VERSION: "2.0.1", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
        ...
        }, o(window).on("load", n), t.exports = s.figure = {VERSION: "2.0.3", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
        ...
        i(15);
        var a = i(4), r = i(31);
        o(n), t.exports = s.footer = {VERSION: "3.1.2", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
        ...
        var o = i(1), s = i(2);
        i(20), o(n), t.exports = s.gallery = {VERSION: "3.0.0", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
            function t() {
        ...
        var o = i(1), s = i(2);
        i(23), o(n), t.exports = s.gotop = {VERSION: "4.0.2", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
        ...
        var o = i(1), s = i(2);
        o(n), t.exports = s.header = {VERSION: "2.0.0", init: n}
    }, function (t, e, i) {
        "use strict";
        var n = i(2);
        t.exports = n.intro = {
        ...
        function o() {
            var t = document.querySelector(".am-map"), e = 116.331398, i = 39.897445, n = t.getAttribute("data-name"), o = t.getAttribute("data-address"), s = t.getAttribute("data-longitude") || e, a = t.getAttribute("data-latitude") || i, r = t.getAttribute("data-setZoom") || 17, l = t.getAttribute("data-icon"), c = new BMap.Map("bd-map"), h = new BMap.Point(s, a);
            ...
            var d = {width: 200, title: n}, p = new BMap.InfoWindow("\u5730\u5740\uff1a" + o, d), m = new BMap.Geocoder;
        ...
        var s = i(1), a = i(2), r = function () {
            s(".am-map").length && n(o)
        };
        s(r), t.exports = a.map = {VERSION: "2.0.2", init: r}
    }, function (t, e, i) {
        "use strict";
        function n() {
            if (o("#mechat").length) {
        ...
        var o = i(1), s = i(2);
        o(window).on("load", n), t.exports = s.mechat = {VERSION: "2.0.1", init: n}
    }, function (t, e, i) {
        "use strict";
        var n = i(1), o = i(2), s = i(14);
        i(16), i(7);
        var a = function () {
            ...
            i.find("a").not(".am-parent>a").on("click", function (t) {
                ...
                var e, i = n(this), o = n('<div class="am-menu-nav-sub-wrap"></div>'), a = 0, r = i.find(".am-menu-nav"), l = r.children("li");
                ...
                var c = new s("#am-menu-" + t, {eventPassthrough: !0, scrollX: !0, scrollY: !1, preventDefault: !1});
                l.on("click", function () {
                    var t = n(this);
                    ...
                    var s, a = n(this).index() > e, l = n(this)[a ? "next" : "prev"](), h = l.offset() || n(this).offset(), u = i.offset(), d = parseInt(i.css("padding-left"));
        ...
        n(a), t.exports = o.menu = {VERSION: "4.0.3", init: a}
    }, function (t, e, i) {
        "use strict";
        function n() {
            function t() {
        ...
        var o = i(1), s = i(2), a = i(25), r = i(26);
        i(15), o(n), t.exports = s.navbar = {VERSION: "2.0.2", init: n}
    }, function (t, e, i) {
        "use strict";
        var n = i(2);
        ...
        function n() {
            ...
            t.each(function (t) {
                var e = o(this), i = s.utils.parseOptions(e.attr("data-am-paragraph")), n = t;
        ...
        }, o(window).on("load", n), t.exports = s.paragraph = {VERSION: "2.0.1", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
        ...
        var o = i(1), s = i(2);
        i(11), o(n), t.exports = s.slider = {VERSION: "3.0.1", init: n}
    }, function (t, e, i) {
        "use strict";
        function n() {
        ...
        var o = i(1), s = i(2);
        i(28), o(n), t.exports = s.tab = {VERSION: "4.0.1", init: n}
    }, function (t, e, i) {
        "use strict";
        var n = i(2);
        ...
        var o = i(1), s = i(2), a = window.navigator.userAgent.indexOf("MicroMessenger") > -1, r = n;
        o(r), t.exports = s.pay = {VERSION: "1.0.0", init: r}
    }])
});